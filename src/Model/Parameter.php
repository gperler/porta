...
class Parameter extends ArraySerializableModel
{
    ...
    public function __construct()
    {
        parent::__construct([
            ...
            new ModelProperty("allowEmptyValue", ModelProperty::TYPE_BUILD_IN),
            new ModelProperty("style"),
            new ModelProperty("explode"),
            new ModelProperty("allowReserved", ModelProperty::TYPE_BUILD_IN),
